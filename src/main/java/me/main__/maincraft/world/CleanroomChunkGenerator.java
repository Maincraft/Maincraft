/*
 * CleanroomGenerator (https://github.com/nvx/CleanroomGenerator/).
 * I hope it's okay that I'm using it :)
 */
...
public class CleanroomChunkGenerator extends ChunkGenerator {
    ...
    public CleanroomChunkGenerator(String id) {
        ...
        if (id != null) {
            try {
                ...
                if (id.length() > 0) {
                    ...
                    for (int i = 0; i < tokens.length; i += 2) {
                        ...
                        if ((height <= 0) || (height > 127)) {
                            System.out.println("Invalid height '" + tokens[i]
                                    + "'. Using 64 instead.");
                            height = 64;
                        }
                        ...
                        if ((height + y) > 127) {
                            System.out
                                    .println("Maximum height reached, ignoring additional layers.");
                            break;
                        }
                        ...
                        if (mat == null) {
                            ...
                            if (mat == null) {
                                System.out.println("Invalid Block ID '" + tokens[i + 1]
                                        + "'. Defaulting to stone.");
                                mat = Material.STONE;
                            }
                        }
                        ...
                        if (!mat.isBlock()) {
                            System.out.println("Error, '" + tokens[i + 1]
                ...
                System.out.println("Error parsing CleanroomGenerator ID '" + id
    ...
    public Location getFixedSpawnLocation(World world, Random random) {
        ...
        if ((world.getHighestBlockYAt(0, 0) <= 0)
                && (world.getBlockAt(0, 0, 0).getType() == Material.AIR)) // SPACE!
        {
